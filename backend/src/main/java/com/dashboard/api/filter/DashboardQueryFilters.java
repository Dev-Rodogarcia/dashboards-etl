...
public final class DashboardQueryFilters {
    ...
    public static ParametroLista of(Collection<String> valores) {
    ...
    public record ParametroLista(List<String> valores, int vazio) {
    }
}

package com.dashboard.api.policy;
...
public final class EscopoFiliaisUsuarioPolicy {

    public static final String HERDAR_SETOR = "HERDAR_SETOR";
    public static final String TODAS = "TODAS";
    public static final String SELECIONADAS = "SELECIONADAS";
    ...
    public static LinkedHashSet<String> normalizarFiliaisSelecionadas(String tipo, Collection<String> filiais) {
    ...
    public static EscopoFilialService.EscopoFilial resolverSemPapelElevado(UsuarioEntity usuario) {
    ...
    public static List<String> listarFiliaisUsuario(UsuarioEntity usuario) {
    ...
    public static List<String> listarFiliaisSetor(UsuarioEntity usuario) {

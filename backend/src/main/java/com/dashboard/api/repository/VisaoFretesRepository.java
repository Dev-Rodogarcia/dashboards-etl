    ...
    String FRETES_FILTRADOS_SQL = """
            WITH fretes AS (
                SELECT
                    ...
                    TRY_CONVERT(datetimeoffset, [Data frete]) AS data_frete,
                    ...
                    TRY_CONVERT(date, [Previsão de Entrega]) AS previsao_entrega,
                    ...
                    TRY_CONVERT(datetimeoffset, [CT-e Emissão]) AS cte_emissao,
                    TRY_CONVERT(datetimeoffset, [data_referencia_faturamento]) AS data_referencia_faturamento,
                    TRY_CONVERT(date, [data_referencia_faturamento]) AS data_referencia_periodo,

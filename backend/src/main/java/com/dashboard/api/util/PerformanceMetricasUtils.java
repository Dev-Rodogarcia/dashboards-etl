...
public final class PerformanceMetricasUtils {

    public static final String STATUS_PENDENTE = "Pendente";
    public static final String STATUS_EM_TRANSITO = "Em Trânsito";
    public static final String STATUS_FINALIZADA = "Finalizada";
    public static final String STATUS_CANCELADA = "Cancelada";
    public static final String STATUS_EM_TRATATIVA = "Em Tratativa";
    public static final String PERFORMANCE_NO_PRAZO = "NO PRAZO";
    public static final String PERFORMANCE_FORA_DO_PRAZO = "FORA DO PRAZO";
    ...
    public static Integer diferencaDias(LocalDate dataPrevisaoEntrega, LocalDate dataFinalizacao) {
    ...
    public static String performanceStatus(Integer diferencaDias) {
    ...
    public static String performanceStatusDias(Integer diferencaDias) {
        if (diferencaDias == null) {
            return null;
        }

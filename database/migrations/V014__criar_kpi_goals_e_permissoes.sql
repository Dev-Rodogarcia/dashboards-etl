...
BEGIN
    CREATE TABLE acesso.kpi_goals (
        ...
        competencia        DATE                 NOT NULL CONSTRAINT DF_kpi_goals_competencia DEFAULT (DATEFROMPARTS(YEAR(SYSUTCDATETIME()), MONTH(SYSUTCDATETIME()), 1)),
        ...
        CONSTRAINT UQ_kpi_goals_branch_indicator_competencia UNIQUE (branch_id, indicator_key, competencia),
        ...
        CONSTRAINT CK_kpi_goals_competencia_primeiro_dia CHECK (DAY(competencia) = 1),

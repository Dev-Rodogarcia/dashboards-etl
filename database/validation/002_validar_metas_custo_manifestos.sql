...
IF NOT EXISTS (
    ...
    THROW 50288, 'Indice unico por filial e competencia nao encontrado ou invalido.', 1;
...
IF NOT EXISTS (
    ...
    THROW 50289, 'Indice unico global por competencia nao encontrado ou invalido.', 1;

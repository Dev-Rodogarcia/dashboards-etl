...
:r dashboard-api/src/main/resources/db/migration/V007__criar_estrutura_horarios_corte.sql
GO
...
:r dashboard-api/src/main/resources/db/migration/V010__garantir_usuario_supremo_desenvolvedor.sql
